...
alter table add constraint pk_venta primary key (nro_factura);
...
alter table add constraint pk_venta primary key (nro_factura, nro_producto);
alter table add constraint fk_nro_factura foreign key (nro_factura) references venta (nro_factura);
